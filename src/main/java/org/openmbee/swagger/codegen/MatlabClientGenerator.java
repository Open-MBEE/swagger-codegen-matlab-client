...
public class MatlabClientGenerator extends DefaultCodegen implements CodegenConfig {
    ...
    public MatlabClientGenerator() {
        super();
        outputFolder = "generated-code" + File.separator + "matlab";
    ...
    public String toOperationId(String operationId) {
        return snakeCase(sanitizeName(operationId));
    }
    ...
    public String toModelName(String name) {
        ...
        return filterNonAlphanumeric(n);
    }
    ...
    public String snakeCase(String s) {
        ...
        return String.join("_", s.split("(?<!(^|[A-Z]))(?=[A-Z])|(?<!^)(?=[A-Z][a-z])")).toLowerCase();
    }
